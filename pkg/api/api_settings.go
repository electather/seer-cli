...
type ApiSettingsCacheDnsDnsEntryFlushPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	dnsEntry string
}

func (r ApiSettingsCacheDnsDnsEntryFlushPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.SettingsCacheDnsDnsEntryFlushPostExecute(r)
}

/*
SettingsCacheDnsDnsEntryFlushPost Flush a specific DNS cache entry

Flushes a specific DNS cache entry

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param dnsEntry
 @return ApiSettingsCacheDnsDnsEntryFlushPostRequest
*/
func (a *SettingsAPIService) SettingsCacheDnsDnsEntryFlushPost(ctx context.Context, dnsEntry string) ApiSettingsCacheDnsDnsEntryFlushPostRequest {
	return ApiSettingsCacheDnsDnsEntryFlushPostRequest{
		ApiService: a,
		ctx: ctx,
		dnsEntry: dnsEntry,
...
// Execute executes the request
func (a *SettingsAPIService) SettingsCacheDnsDnsEntryFlushPostExecute(r ApiSettingsCacheDnsDnsEntryFlushPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsCacheDnsDnsEntryFlushPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsMetadatasGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiSettingsMetadatasGetRequest) Execute() (*MetadataSettings, *http.Response, error) {
	return r.ApiService.SettingsMetadatasGetExecute(r)
}

/*
SettingsMetadatasGet Get Metadata settings

Retrieves current Metadata settings.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsMetadatasGetRequest
*/
func (a *SettingsAPIService) SettingsMetadatasGet(ctx context.Context) ApiSettingsMetadatasGetRequest {
	return ApiSettingsMetadatasGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsMetadatasGetExecute(r ApiSettingsMetadatasGetRequest) (*MetadataSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsMetadatasGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsMetadatasPutRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	metadataSettings *MetadataSettings
}

func (r ApiSettingsMetadatasPutRequest) MetadataSettings(metadataSettings MetadataSettings) ApiSettingsMetadatasPutRequest {
	r.metadataSettings = &metadataSettings
	return r
}

func (r ApiSettingsMetadatasPutRequest) Execute() (*MetadataSettings, *http.Response, error) {
	return r.ApiService.SettingsMetadatasPutExecute(r)
}

/*
SettingsMetadatasPut Update Metadata settings

Updates Metadata settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsMetadatasPutRequest
*/
func (a *SettingsAPIService) SettingsMetadatasPut(ctx context.Context) ApiSettingsMetadatasPutRequest {
	return ApiSettingsMetadatasPutRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MetadataSettings
func (a *SettingsAPIService) SettingsMetadatasPutExecute(r ApiSettingsMetadatasPutRequest) (*MetadataSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsMetadatasPut")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsMetadatasTestPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	settingsMetadatasTestPostRequest *SettingsMetadatasTestPostRequest
}

func (r ApiSettingsMetadatasTestPostRequest) SettingsMetadatasTestPostRequest(settingsMetadatasTestPostRequest SettingsMetadatasTestPostRequest) ApiSettingsMetadatasTestPostRequest {
	r.settingsMetadatasTestPostRequest = &settingsMetadatasTestPostRequest
	return r
}

func (r ApiSettingsMetadatasTestPostRequest) Execute() (*SettingsMetadatasTestPost200Response, *http.Response, error) {
	return r.ApiService.SettingsMetadatasTestPostExecute(r)
}

/*
SettingsMetadatasTestPost Test Provider configuration

Tests if the TVDB configuration is valid. Returns a list of available languages on success.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsMetadatasTestPostRequest
*/
func (a *SettingsAPIService) SettingsMetadatasTestPost(ctx context.Context) ApiSettingsMetadatasTestPostRequest {
	return ApiSettingsMetadatasTestPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsMetadatasTestPostExecute(r ApiSettingsMetadatasTestPostRequest) (*SettingsMetadatasTestPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SettingsMetadatasTestPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsMetadatasTestPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.settingsMetadatasTestPostRequest == nil {
		return localVarReturnValue, nil, reportError("settingsMetadatasTestPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.settingsMetadatasTestPostRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiSettingsNetworkGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiSettingsNetworkGetRequest) Execute() (*MainSettings, *http.Response, error) {
	return r.ApiService.SettingsNetworkGetExecute(r)
}

/*
SettingsNetworkGet Get network settings

Retrieves all network settings in a JSON object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsNetworkGetRequest
*/
func (a *SettingsAPIService) SettingsNetworkGet(ctx context.Context) ApiSettingsNetworkGetRequest {
	return ApiSettingsNetworkGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return MainSettings
func (a *SettingsAPIService) SettingsNetworkGetExecute(r ApiSettingsNetworkGetRequest) (*MainSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsNetworkGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsNetworkPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	networkSettings *NetworkSettings
}

func (r ApiSettingsNetworkPostRequest) NetworkSettings(networkSettings NetworkSettings) ApiSettingsNetworkPostRequest {
	r.networkSettings = &networkSettings
	return r
}

func (r ApiSettingsNetworkPostRequest) Execute() (*NetworkSettings, *http.Response, error) {
	return r.ApiService.SettingsNetworkPostExecute(r)
}

/*
SettingsNetworkPost Update network settings

Updates network settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsNetworkPostRequest
*/
func (a *SettingsAPIService) SettingsNetworkPost(ctx context.Context) ApiSettingsNetworkPostRequest {
	return ApiSettingsNetworkPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsNetworkPostExecute(r ApiSettingsNetworkPostRequest) (*NetworkSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsNetworkPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsNotificationsNtfyGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiSettingsNotificationsNtfyGetRequest) Execute() (*NtfySettings, *http.Response, error) {
	return r.ApiService.SettingsNotificationsNtfyGetExecute(r)
}

/*
SettingsNotificationsNtfyGet Get ntfy.sh notification settings

Returns current ntfy.sh notification settings in a JSON object.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsNotificationsNtfyGetRequest
*/
func (a *SettingsAPIService) SettingsNotificationsNtfyGet(ctx context.Context) ApiSettingsNotificationsNtfyGetRequest {
	return ApiSettingsNotificationsNtfyGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return NtfySettings
func (a *SettingsAPIService) SettingsNotificationsNtfyGetExecute(r ApiSettingsNotificationsNtfyGetRequest) (*NtfySettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsNotificationsNtfyGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsNotificationsNtfyPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	ntfySettings *NtfySettings
}

func (r ApiSettingsNotificationsNtfyPostRequest) NtfySettings(ntfySettings NtfySettings) ApiSettingsNotificationsNtfyPostRequest {
	r.ntfySettings = &ntfySettings
	return r
}

func (r ApiSettingsNotificationsNtfyPostRequest) Execute() (*NtfySettings, *http.Response, error) {
	return r.ApiService.SettingsNotificationsNtfyPostExecute(r)
}

/*
SettingsNotificationsNtfyPost Update ntfy.sh notification settings

Update ntfy.sh notification settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsNotificationsNtfyPostRequest
*/
func (a *SettingsAPIService) SettingsNotificationsNtfyPost(ctx context.Context) ApiSettingsNotificationsNtfyPostRequest {
	return ApiSettingsNotificationsNtfyPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return NtfySettings
func (a *SettingsAPIService) SettingsNotificationsNtfyPostExecute(r ApiSettingsNotificationsNtfyPostRequest) (*NtfySettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsNotificationsNtfyPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSettingsNotificationsNtfyTestPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	ntfySettings *NtfySettings
}

func (r ApiSettingsNotificationsNtfyTestPostRequest) NtfySettings(ntfySettings NtfySettings) ApiSettingsNotificationsNtfyTestPostRequest {
	r.ntfySettings = &ntfySettings
	return r
}

func (r ApiSettingsNotificationsNtfyTestPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.SettingsNotificationsNtfyTestPostExecute(r)
}

/*
SettingsNotificationsNtfyTestPost Test ntfy.sh settings

Sends a test notification to the ntfy.sh agent.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsNotificationsNtfyTestPostRequest
*/
func (a *SettingsAPIService) SettingsNotificationsNtfyTestPost(ctx context.Context) ApiSettingsNotificationsNtfyTestPostRequest {
	return ApiSettingsNotificationsNtfyTestPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SettingsAPIService) SettingsNotificationsNtfyTestPostExecute(r ApiSettingsNotificationsNtfyTestPostRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsNotificationsNtfyTestPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
