...
type SettingsCacheGet200ResponseImageCache struct {
	...
	Avatar *SettingsCacheGet200ResponseImageCacheTmdb `json:"avatar,omitempty"`
}
...
// SetAvatar gets a reference to the given SettingsCacheGet200ResponseImageCacheTmdb and assigns it to the Avatar field.
