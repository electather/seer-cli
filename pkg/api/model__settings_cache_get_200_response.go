...
type SettingsCacheGet200Response struct {
	...
	DnsCache *SettingsCacheGet200ResponseDnsCache `json:"dnsCache,omitempty"`
...
func (o *SettingsCacheGet200Response) GetDnsCache() SettingsCacheGet200ResponseDnsCache {
	if o == nil || IsNil(o.DnsCache) {
		var ret SettingsCacheGet200ResponseDnsCache
		return ret
	}
	return *o.DnsCache
}
...
// SetDnsCache gets a reference to the given SettingsCacheGet200ResponseDnsCache and assigns it to the DnsCache field.
