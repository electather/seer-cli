...
**WebhookRoleId** | Pointer to **string** |  | [optional] 
...
GetWebhookRoleId returns the WebhookRoleId field if non-nil, zero value otherwise.

### GetWebhookRoleIdOk

`func (o *DiscordSettingsOptions) GetWebhookRoleIdOk() (*string, bool)`

GetWebhookRoleIdOk returns a tuple with the WebhookRoleId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetWebhookRoleId sets WebhookRoleId field to given value.
