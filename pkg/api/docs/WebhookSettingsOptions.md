...
**SupportVariables** | Pointer to **bool** |  | [optional] 
...
GetSupportVariables returns the SupportVariables field if non-nil, zero value otherwise.

### GetSupportVariablesOk

`func (o *WebhookSettingsOptions) GetSupportVariablesOk() (*bool, bool)`

GetSupportVariablesOk returns a tuple with the SupportVariables field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetSupportVariables sets SupportVariables field to given value.
