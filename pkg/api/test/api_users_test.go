...
func Test_api_UsersAPIService(t *testing.T) {
	...
	t.Run("Test UsersAPIService UserUserIdPushSubscriptionEndpointDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.UsersAPI.UserUserIdPushSubscriptionEndpointDelete(context.Background(), userId, endpoint).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdPushSubscriptionEndpointGet", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.UsersAPI.UserUserIdPushSubscriptionEndpointGet(context.Background(), userId, endpoint).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdPushSubscriptionsGet", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.UsersAPI.UserUserIdPushSubscriptionsGet(context.Background(), userId).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdSettingsLinkedAccountsJellyfinDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.UsersAPI.UserUserIdSettingsLinkedAccountsJellyfinDelete(context.Background(), userId).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdSettingsLinkedAccountsJellyfinPost", func(t *testing.T) {
		...
		httpRes, err := apiClient.UsersAPI.UserUserIdSettingsLinkedAccountsJellyfinPost(context.Background(), userId).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdSettingsLinkedAccountsPlexDelete", func(t *testing.T) {
		...
		httpRes, err := apiClient.UsersAPI.UserUserIdSettingsLinkedAccountsPlexDelete(context.Background(), userId).Execute()
	...
	t.Run("Test UsersAPIService UserUserIdSettingsLinkedAccountsPlexPost", func(t *testing.T) {
		...
		httpRes, err := apiClient.UsersAPI.UserUserIdSettingsLinkedAccountsPlexPost(context.Background(), userId).Execute()
